    ...
    <div id="scene" class="header">
        ...
        <div class="layer headerTitle" data-depth="0.05">
            <!-- Text animation -->
            <h1 class="text-wrap">
                <a class="typewrite" data-period="5000" data-type='[ "Full Stack Developer", "Multimedia Artist", "Android Programmer"]'></a>
            </h1>
        </div>
        <!-- Parallax layer 3-->
    ...
    <div class="pt-5 container">
        ...
        <div class="row py-5 no-gutters">
            <div class="col-md-4 ftco-animate p-2 ">    
                <div class="project-block img d-flex align-items-end bgPos-top" style="background-image: url(assets/images/SocialBook_React/SocialBook_SC3.jpg);">
                    <div class="project-overlay"></div>
                    <a href="project-SocialBook.php" class="icon d-flex justify-content-center align-items-center">
                        <i class="fas fa-external-link-alt fa-2x"></i>
                    </a>
                    <div class="desc w-100 px-4">
                        <div class="text w-100 mb-3">
                            <span>Web App Development</span>
                            <h2><a href="work-single.html">SocialBook, a Facebook clone</a></h2>
                        </div>
                    </div>
                </div>
            </div>
