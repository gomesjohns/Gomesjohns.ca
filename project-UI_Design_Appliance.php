    ...
    <div class="py-5 container">
        ...
        <div class="row project-title">
            <div class="m-auto heading-section text-center ">
                <h1>Appliance Management UI</h1>
                <p>User interface design for an appliance management app.
                </p>    
            </div>
        </div>
        ...
        <div class="tools-used mt-4 text-center row ">
            <div class="m-auto w-15 pExtra-left">
            ...
            <div class="m-auto w-15 pExtra-right">
                <img src="https://img.icons8.com/color/40/000000/adobe-illustrator.png" alt="Logo of illustrator" title="Illustrator">
                <span class="text-muted display-block text-small">Illustrator</span>
            </div>
        ...
        <div class="row py-5 no-gutters">
                ...
                <div class="project-block img d-flex align-items-end bgPos-top" style="background-image: url(assets/images/UI_design_Appliance_Android/UI_Design_Appliance_SC2.jpg);">
                    ...
                    <div class="desc w-100 px-4">
                            <div class="text w-100 mb-3 text-small">
                                <span>Home screen of the app allows the user to view the appliance list and update any specific appliance.
                                </span>
                            </div>
                        </div>
                </div>
            ...
            <div class="col-md-4 ftco-animate p-2 ">    
                <div class="project-block img d-flex align-items-end bgPos-top" style="background-image: url(assets/images/UI_design_Appliance_Android/UI_Design_Appliance_SC1.jpg);">
                    ...
                    <div class="desc w-100 px-4">
                            <div class="text w-100 mb-3 text-small">
                                <span>User is given a list of appliances that are connected to the application. They can update the on/off state and other properties 
                                    of these appliances.
                                </span>
                            </div>
                        </div>
            ...
            <div class="col-md-4 ftco-animate p-2 ">    
                <div class="project-block img d-flex align-items-end bgPos-top" style="background-image: url(assets/images/UI_design_Appliance_Android/UI_Design_Appliance_SC3.jpg);">
                    ...
                    <div class="desc w-100 px-4">
                            <div class="text w-100 mb-3 text-small">
                                <span>User can scan the home hub to add appliances to the list.</span>
                            </div>
                        </div>
                </div>
            </div>
            ...
            <div class="col-md-4 ftco-animate p-2 ">    
                <div class="project-block img d-flex align-items-end bgPos-top" style="background-image: url(assets/images/UI_design_Appliance_Android/UI_Design_Appliance_SC4.jpg);">
                    ...
                    <div class="desc w-100 px-4">
                            <div class="text w-100 mb-3 text-small">
                                <span>User is given full control over the thermostat. They can increase or decrease the termperature and view 
